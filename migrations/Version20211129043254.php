 ...
 */
final class Version20211129043254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles CHANGE auteurs_id auteurs_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles CHANGE auteurs_id auteurs_id INT NOT NULL');
    }
}
